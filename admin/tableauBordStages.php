...
// Convertit le numéro d'un état sélectionné, en le libellé correspondant
...
echo "<br/>";
// $fb->addTextField("Chercher une entreprise ","search_entreprise", false);
// //("Entreprise", "entreprise", false, DBEntreprise::getEnumeration(false), "Toutes les entreprises", "", "", false, "onchange='refreshPage();'");
// echo "<br/>";
?>
  L&#233;gende :<br/>
...
// Affichage des propositions correspondant aux critères
...
// Affichage des fiches correspondant aux critères
