...
echo "<h2>Remise des fiches de stage aux &#233;tudiants</h2>";
$fb = new FormBuilder("traitementSignatureEntrepriseFicheStage.php", "POST");
$fb->beginForm();
...
$listeFiches=$idtype!=""?DBFicheStage::getRecords("",$idtype,"",DBConfig::getConfigValue("ANNEE PROMO"),"","","","","","","","","","","","","","","","","","",DBFicheStage::$ETAT_STAGE_VALIDEE):array();
...
if (isset($_GET[FOGestionFicheStage::$CHAMP_FORM_ID_FICHE]) and $_GET[FOGestionFicheStage::$CHAMP_FORM_ID_FICHE]!=""){
	  echo "<hr>";
	  echo "<center><input type='submit' value='Remis Etudiant' name='action'/></center><br/><br/>";
