...
//variables représentant les valeurs de l'enum de l'attribut "etat_stage"
	...
	/**
	* @var String Variable représentant les valeurs de l'enum de l'attribut "etat_stage". Chaine stockée pour l'état attente de validation de la fiche de stage : "En attente de validation"
	*/
    public static $ETAT_STAGE_ATTENTE_VALIDATION = "En attente de validation";
	/**
	* @var String Variable représentant les valeurs de l'enum de l'attribut "etat_stage". Chaine stockée pour l'état validée de la fiche de stage : "Validee"
	*/
    public static $ETAT_STAGE_VALIDEE = "Validee";
	/**
	* @var String Variable représentant les valeurs de l'enum de l'attribut "etat_stage". Chaine stockée pour l'état refusée de la fiche de stage : "Conventionnée"
	*/
	...
	*/
    ...
    /**
	* @var String Variable représentant les valeurs de l'enum de l'attribut "etat_stage". Chaine stockée pour l'état terminée de la fiche de stage : "Terminee"
	*/
	public static $ETAT_STAGE_TERMINEE = "Terminee";
    /**
	* @var String Variable représentant les valeurs de l'enum de l'attribut "etat_stage". Chaine stockée pour l'état refusée de la fiche de stage : "Refusee"
	*/
...
//variables de la table concernant les fiches de stages
	...
	* @param int Idenfifiant du type de stage lié à ce stage.
	* @param String Libellé du type de stage lié à ce stage.
	* @param int Année de la fiche de stage
	* @param int Identifiant de l'étudiant concerné par la fiche de stage
	* @param String Nom de l'étudiant concerné par la fiche de stage
	* @param String Prénom de l'étudiant concerné par la fiche de stage
	* @param int Identifiant de l'entreprise concernée par la fiche de stage
	* @param String Raison sociale de l'entreprise concernée par la fiche de stage
	* @param int Identifiant du maitre de stage
	* @param String Nom du maitre de stage
	* @param String Prénom du maitre de stage
	* @param int Identifiant du signataire de stage
	* @param String Nom du signataire de stage
	* @param String Prénom du signataire de stage
	* @param String Intitulé du stage
	...
	* @param Enum Etat de la fiche de stage. Prend l'une des valeurs définie dans les variables statiques définies dans cette classe.
	* @param Date Date de la création de la fiche de stage
	* @param Date Date de la dernière modification de la fiche de stage
	...
	* @param String Avis de l'étudiant sur le stage
	...
	*/
	...
	/**
	* @abstract Méthode statique. Vérifie que la table 'fiche_stage' existe
	...
	*/
	...
	/**
	* @abstract Méthode statique. Permet de créer la table fiche_stage
	* @access public
	*/
	...
	/**
	* @abstract Insère dans la base de données une nouvelle fiche de stage
	* @param DBTypeStage Objet contenant le type de stage correspondant à la fiche de stage
	* @param DBEtudiant Objet contenant l'étudiant effectuant le stage
	...
	* @param Date Date de fin du stage
	* @param String Domaine d'application du stage
	* @param String Technologie utilisée pendant le stage
	* @param String Description de la technologie utilisée pendant le stage
	* @param Enum Etat de la fiche de stage. Prend l'une des valeurs définie dans les variables statiques définies dans cette classe.
	* @param Date Date de la création de la fiche de stage
	* @param Date Date de la dernière modification de la fiche de stage
	...
	*/
	...
	/**
	* @abstract Méthode statique. Construit une requête de sélection à partir des paramètres, l'exécute, puis retourne un tableau contenant les objets DBFicheStage correspondants. L'ensemble des paramètres peuvent etre absent, dans ce cas l'ensemble de la table est retournée.
	* @param int Identifiant de la fiche de stage.
	* @param int Idenfifiant du type de stage lié à ce stage.
	* @param String Libellé du type de stage lié à ce stage.
	* @param int Année de la fiche de stage
	...
	* @param String Avis du tuteur sur le stage
	* @param int Identifiant de la proposition de stage. -1 si pas de proposition de stage
	* @return Array Tableau contenant les objets de type DBFicheStage correspondant aux ligne de la base de données que l'on vient de récupérer
	* @access public
	*/
	...
	*/
	...
	/**
	* @abstract Construit une requête de suppression et l'exécute. La clause where de la requete est automatiquement construite avec l'identifiant de la fiche de stage stocké dans l'Objet courant.
	* @access public
	*/
...
//renvois des cles etrangeres sous forme d'objet
	...
	* @return DBTypeStage Objet contenant les informations du type du stage en cas de succés, FALSE sinon.
	* @access public
	*/
	...
	/**
	* @abstract Retourne l'étudiant stagiaire sous la forme d'objet
	* @return DBEtudiant Objet contenant les informations de l'étudiant stagiaire en cas de succés, FALSE sinon.
	* @access public
	*/
	...
	* @return DBEntreprise Objet contenant les informations de l'entreprise en cas de succés, FALSE sinon.
	* @access public
	*/
	...
	* @return DBContactEtp Objet contenant les informations du maitre de stage en cas de succés, FALSE sinon.
	* @access public
	*/
	...
	* @return DBContactEtp Objet contenant les informations du signataire du stage en cas de succés, FALSE sinon.
	* @access public
	*/
	...
	* @return DBEnseignant Objet contenant les informations du tuteur du stage en cas de succés, FALSE sinon.
	* @access public
	*/
	...
	* @return DBEnseignant Objet contenant les informations du relecteur du stage en cas de succés, FALSE sinon.
	* @access public
	*/
	...
	* @return DBEnseignant Objet contenant les informations de la proposition de stage en cas de succés, FALSE sinon.
	* @access public
	*/
	...
	/**
	* @abstract Modifie la fiche de stage à partir des attributs de l'objet courant. Cette méthode utilise la méthode 'updateRecord' et lui passe en paramètre les attributs de l'objet courant.
	* @access public
	*/
	...
	*/
	...
	/**
	* @abstract La fiche de stage est remise à l'étudiant pour signature de l'entreprise et l'enregistre dans la base.
	* @access public
	*/
	...
	/**
	* @abstract La fiche a été signé par l'universite et l'enregistre dans la base.
	* @access public
	*/
	...
	* @param DBEnseignant Objet contenant les information de l'enseignant qui doit etre affecté comme tuteur
	* @return Bool TRUE en cas de succés, FALSE sinon.
	* @access public
	*/
	...
	/**
	* @abstract Désaffecte le tuteur du stage et enregistre dans la base
	* @return Bool TRUE en cas de succés, FALSE sinon.
	* @access public
	*/
	...
	* @param DBEnseignant Objet contenant les information de l'enseignant qui doit etre affecté comme relecteur
	* @return Bool TRUE en cas de succés, FALSE sinon.
	* @access public
	*/ 
	...
	/**
	* @abstract Désaffecte le relecteur du stage et enregistre dans la base
	* @return Bool TRUE en cas de succés, FALSE sinon.
	* @access public
	*/	
	...
	*/
	...
	/**
	* @abstract Retourne le nom et le prénom de l'étudiant stagiaire.
	* @return String le nom et le prénom de l'étudiant sous la forme suivante : <nom> <prénom>
	* @access public
	*/
	...
	/**
	* @abstract Retourne l'identifiant de la fiche de stage.Synonyme de la méthode getIdStage()
	...
	*/
	...
	/**
	* @abstract Retourne l'étudiant avec son tuteur et son relecteur pour un affichage.
	* @return String Etudiant, tuteur et relecteur sous la forme suivante : <NomEtudiant> <PrénomEtudiant> (<PrénomTuteur> <NomTuteur>, <PrénomRelecteur> <NomRelecteur>). Si il n'y a pas de tuteur ou de relecteur leur nom et prénom son remplacé par 'Personne'.
	* @access public
	*/
	...
	/**
	* @abstract Méthode statique. Retourne l'ensemble des fiches de stage auxquelles un tuteur ou un relecteur sont déjà affectés et qui ne sont pas dans l'état 'attente de validation' ni 'refusée'.
	...
	*/
	...
	/**
	* @abstract Méthode statique. Retourne l'ensemble des fiches de stage auxquelles ni tuteur ni relecteur sont affectés et qui ne sont pas dans l'état 'attente de validation' ni 'refusée'.
	* @param int Idenfifiant du type de stage sur lequel se porte la recherche
	* @return Array Tableau contenant les objets DBFicheStage que l'on recherche.
	* @access public
	*/
	...
	/**
	* @abstract Méthode statique. Retourne l'ensemble des fiches de stage auxquelles une soutenance est déjà affectée et qui ne sont pas dans l'état 'attente de validation' ni 'refusée'.
	* @param int Idenfifiant du type de stage sur lequel se porte la recherche
	* @return Array Tableau contenant les objets DBFicheStage que l'on recherche.
	* @access public
	*/
	...
	/**
	* @abstract Méthode statique. Retourne l'ensemble des fiches de stage auxquelles aucune soutenance est affectée et qui ne sont pas dans l'état 'attente de validation' ni 'refusée'.
	* @param int Idenfifiant du type de stage sur lequel se porte la recherche
	* @return Array Tableau contenant les objets DBFicheStage que l'on recherche.
	* @access public
	*/
	...
	/**
	* @abstract Méthode statique. Retourne l'ensemble des fiches de stage auxquelles aucune visite n'est affectée et qui ne sont pas dans l'état 'attente de validation' ni 'refusée'.
	* @param int Idenfifiant du type de stage sur lequel se porte la recherche
	* @param int Identifiant de l'enseignent pour lequel on recherche les stage qu'il n'a pas visité
	* @return Array Tableau contenant les objets DBFicheStage que l'on recherche.
	* @access public
	*/
	...
	/**
	* @abstract Méthode statique. Retourne l'ensemble des stages visités et qui ne sont pas dans l'état 'attente de validation' ni 'refusée'.
	* @param int Idenfifiant du type de stage sur lequel se porte la recherche
	* @param int Identifiant de l'enseignent pour lequel on recherche les stages qu'il n'a pas visité
	* @return Array Tableau contenant les objets DBFicheStage que l'on recherche.
	* @access public
	*/
	...
	/**
	* @abstract Permet d'ajouter une fiche de stage à l'aide de la méthode 'createRecord'. Cette méthode contient moins de paramètre car certains sont automatiquements affectés.
	* @param DBTypeStage Objet contenant le type de stage correspondant à la fiche de stage
	* @param DBEtudiant Objet contenant l'étudiant effectuant le stage
	* @param DBEntreprise Objet contenant l'entreprise dans laquelle le stage s'effectu
	* @param DBContactEtp Objet contenant le maitre de stage
	...
	*/
	...
	/**
	* @abstract Méthode pour la modification d'une fiche de stage dans la base en fonction des informations passées en parametre. Seules infos modifiable par le site.
	* @param DBTypeStage Objet contenant le type de stage correspondant à la fiche de stage
	* @param DBEtudiant Objet contenant l'étudiant effectuant le stage
	* @param DBEntreprise Objet contenant l'entreprise dans laquelle le stage s'effectu
	* @param DBContactEtp Objet contenant le maitre de stage
	...
	*/
	...
	/**
	* @abstract Affecte à l'objet courant et enregistre dans la base l'avis sur la visite du tuteur.
	* @param String Evaluation de la corespondance entre le stagiaire et son tuteur
	* @param String Avis du maitre de stage sur le stage
	* @param String Avis de l'étudiant sur le stage
	* @param String Avis du tuteur sur le stage
	* @param Date Date de la visite au stagiaire
	* @return TRUE en cas de succés, FALSE sinon.
	* @access public
	*/	
	...
	/**
	* @abstract Méthode statique. Retourne la ou les fiche(s) de stages de l'étudiant passé en paramètre 
	* @param DBEtudiant Objet contenant les informations de l'étudiant pour lequel on souhaite récupérer la ou les fiche(s) de stage
	* @return Array Tableau contenant les objets de type DBFicheStage correspondant aux ligne de la base de données que l'on vient de récupérer
	* @access public
	*/
    ...
    /**
	* @abstract Méthode statique. Retourne la ou les fiche(s) de stage validée(s) de l'étudiant passé en paramètre pour le type de stage passé en paramètre. Les fiches retournées sont celles pour l'année de la promo est celui stocké dans la table 'config'. Les fiches retournés sont triées sur le nom de l'étudiant.
	* @param DBEtudiant Objet contenant les informations de l'étudiant pour lequel on souhaite récupérer la ou les fiche(s) de stage validées. Prend la valeur NULL si non renseigné
	...
	*/	
	...
	/**
	* @abstract Méthode statique. Retourne la ou les fiche(s) de stage validée(s) de l'étudiant passé en paramètre pour le type de stage passé en paramètre. Les fiches retournées sont celles pour l'année de la promo est celui stocké dans la table 'config'. Les fiches retournées sont triées sur le nom de l'étudiant.
	* @param DBEtudiant Objet contenant les informations de l'étudiant pour lequel on souhaite récupérer la ou les fiche(s) de stage validées. Prend la valeur NULL si non renseigné
	* @param DBTypeStage Objet contenant le type de stage pour lequel on recherche les fiches de stage.
	* @return Array Tableau contenant les objets de type DBFicheStage correspondant aux ligne de la base de données que l'on vient de récupérer
	* @access public
	*/ 
	...
	/**
	* @abstract Méthode statique. Retourne l'ensemble des fiches de stage auxquelles un tuteur ou un relecteur sont déjà affectés et qui ne sont pas dans l'état 'attente de validation' ni 'refusée'. Synonyme de 'getFichesStagesAffecteesTuteur()'.
	* @param int Idenfifiant du type de stage sur lequel se porte la recherche
	...
	*/
	...
	/**
	* @abstract Retourne la liste des adresses mails de l'étudiant concerné par la fiche de stage.
	* @return String Liste des adresses mails séparées par des ','
	* @access private
	*/
	...
	/**
	* @abstract Envoi un mail de refus de la fiche de stage à l'étudiant
	* @return Bool TRUE si le mail est accepté pour livraison, FALSE sinon
	* @access public
	*/
    ...
    /**
	* @abstract Envoi un mail de création de la fiche de stage à l'étudiant concerné
	* @return Bool TRUE si le mail est accepté pour livraison, FALSE sinon
	* @access public
	*/
    ...
    /**
	* @abstract Envoi un mail de création de la fiche de stage aux administrateurs
	* @return Bool TRUE si le mail est accepté pour livraison, FALSE sinon
	* @access public
	*/
	...
	/**
	* @abstract Envoi un mail de validation de la fiche de stage à l'étudiant concerné
	* @return Bool TRUE si le mail est accepté pour livraison, FALSE sinon
	* @access public
	*/
	...
	/**
	* @abstract Envoi un mail de validation d'une fiche de stage au secrétariat
	* @return Bool TRUE si le mail est accepté pour livraison, FALSE sinon
	* @access public
	*/
	...
	/**
	* @abstract Envoi un mail de recupération de la fiche par l'étudiant pour la signature entreprise de la fiche de stage à l'étudiant concerné
	* @return Bool TRUE si le mail est accepté pour livraison, FALSE sinon
	* @access public
	*/
	public function sendMailSignatureEntreprise(){
        ...
        if(!$m->sendMail($this->createListMailEtudiant(), DBConfig::getConfigValue("MAIL SECRETARIAT"), $reply, "Fiche de stage remis à l'étudiant"))
            return false;
        else
            return true;
	}
	...
	/**
	* @abstract Envoi un mail indiquant que la fiche de stage à l'étudiant concerné a été signé par l'Université
	* @return Bool TRUE si le mail est accepté pour livraison, FALSE sinon
	* @access public
	*/
	public function sendMailSignatureUniversite(){
        ...
        if(!$m->sendMail($this->createListMailEtudiant(), DBConfig::getConfigValue("MAIL SECRETARIAT"), $reply, "Fiche de stage signée par l'Université"))
            return false;
        else
            return true;
	}
	...
	/**
	* @abstract Envoi un mail de finalisation de la fiche de stage à l'étudiant concerné
	* @return Bool TRUE si le mail est accepté pour livraison, FALSE sinon
	* @access public
	*/
	public function sendMailFinalisation(){
        ...
        if(!$m->sendMail($this->createListMailEtudiant(), DBConfig::getConfigValue("MAIL SECRETARIAT"), $reply, "Fiche de stage finalisée"))
            return false;
        else
            return true;
	}
