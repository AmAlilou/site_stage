...
class FormBuilder {
	 ...
	 * @param
	 *        	bool Définit le type de document envoyé au serveur lorsque l'attribut method vaut post.
	 * @param
	 *        	Array les parametres complémentaires
	 */
	 ...
	 * @param
	 *        	bool définit un champ de type password, ilne sera jamais rempli par défaut
	 * @param
	 *        	String la taille du champ
	 * @param
	 *        	String le nombre maximal de caractère possible
	 * @param
	 *        	String valeur qui sera affichée par défaut (voir le commentaire général de la classe)
	 * @param
	 *        	String valeur courante, utilisée lors des modification et des réaffichage de formulaire (voir le commentaire général de la classe)
	 * @param
	 *        	Array parametres supplémentaires
	 */
	 ...
	 * @param
	 *        	String le bouton radio défini par défaut
	 * @param
	 *        	String la valeur courante, le bouton radio sélectionné en cas de modification ou de réaffichage
	 * @param
	 *        	bool true les boutons radio sont affichés les uns en dessous des autres, sinon en ligne
	 * @param
	 *        	Array parametres supplémentaires
	 */
	 ...
	 *        	String nom du champ
	 * @param
	 *        	bool true la checkbox est cochée
	 */
	 ...
	 *        	Array le tableau à afficher
	 * @param
	 *        	String le message par défaut
	 * @param
	 *        	String le bouton radio défini par défaut
	 * @param
	 *        	String la valeur courante, le bouton radio sélectionné en cas de modification ou de réaffichage
	 * @param
	 *        	bool true n'affiche pas le champ d'aide à la recherche dans la liste
	 * @param
	 *        	Array parametres supplémentaires
	 */
...
/**
 * Classe utilisée par le FormBuilder .
