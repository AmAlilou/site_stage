...
// Forcage de la persistance des connexions pour améliorer les performances et éviter les erreurs
// (sans persistance, on se connecte/deconnecte a la base de données a chaque requete)
