...
echo "<h2>Finalisation des fiches de stage</h2>";
$fb = new FormBuilder("traitementFinalisationFicheStage.php", "POST");
$fb->beginForm();
...
$listeFiches=$idtype!=""?DBFicheStage::getRecords("",$idtype,"",DBConfig::getConfigValue("ANNEE PROMO"),"","","","","","","","","","","","","","","","","","",DBFicheStage::$ETAT_STAGE_SIGNATURE_UNIVERSITE):array();
...
if (isset($_GET[FOGestionFicheStage::$CHAMP_FORM_ID_FICHE]) and $_GET[FOGestionFicheStage::$CHAMP_FORM_ID_FICHE]!=""){
	  echo "<hr>";
	  echo "<center><input type='submit' value='Finaliser' name='action'/></center><br/><br/>";
